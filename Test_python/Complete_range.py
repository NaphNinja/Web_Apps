...
# Enter the elements for the deleter range which will delete elements from the combined range
# Enter the elements for the querey range which will find particular ranges from the combined range
# This program will print all results based on each user input.
